...
<style scoped>
.calendar-view{height:100%;display:flex;flex-direction:column;background:var(--color-bg);color:var(--color-text);padding:24px;}
.calendar-header{display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;}
.nav-btn{background:var(--color-surface);border:1px solid var(--color-border);color:var(--color-text);padding:6px 12px;margin-right:8px;border-radius:6px;cursor:pointer;}
.nav-btn:hover{background:var(--color-surface-raised);}
.current-label{font-size:20px;font-weight:600;}
.create-event-btn{display:flex;align-items:center;gap:8px;background:var(--color-accent-subtle);border:1px solid rgba(200,75,17,0.2);color:var(--color-accent);padding:8px 16px;border-radius:6px;cursor:pointer;font-size:14px;font-weight:500;margin-right:12px;}
.create-event-btn:hover{background:rgba(200,75,17,0.14);}
.create-event-btn svg{width:16px;height:16px;}
.view-select,.artist-select{background:var(--color-surface);border:1px solid var(--color-border);color:var(--color-text);padding:6px 12px;border-radius:6px;margin-left:8px;}
.list-view{display:flex;flex-direction:column;gap:12px;}
.event-row{display:grid;grid-template-columns:120px 80px 1fr 160px;gap:12px;padding:12px;border:1px solid var(--color-border);border-radius:8px;background:var(--color-surface);}
.event-row:hover{background:var(--color-surface-raised);}
.date{color:var(--color-text-secondary);} .time{color:var(--color-text-tertiary);} .artist{color:var(--color-text-secondary);}
.placeholder{padding:60px;text-align:center;color:var(--color-text-tertiary);}
.month-grid{display:grid;grid-template-columns:repeat(7,1fr);grid-auto-rows:100px;border:1px solid var(--color-border);}
.month-cell{border:1px solid var(--color-border);padding:4px;position:relative;}
.month-cell.other{background:var(--color-bg);color:var(--color-text-tertiary);}
.month-cell.header{background:var(--color-surface-raised);font-weight:600;text-align:center;height:32px;display:flex;align-items:center;justify-content:center;color:var(--color-text);}
.day-num{font-size:12px;}
.events-mini{position:absolute;bottom:4px;left:4px;display:flex;gap:2px;flex-wrap:wrap;}
.mini-dot{width:6px;height:6px;border-radius:50%;background:var(--color-accent);}
/* Week grid */
.week-grid{display:grid;grid-template-columns:repeat(7,1fr);gap:8px;}
.week-day{background:var(--color-surface);border:1px solid var(--color-border);border-radius:8px;padding:6px;display:flex;flex-direction:column;min-height:120px;}
...
.week-ev{color:var(--color-accent);}
