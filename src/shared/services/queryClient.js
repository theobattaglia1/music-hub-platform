...
export const prefetchQueries = {
  ...
  artistDetail: (id) =>
    queryClient.prefetchQuery({
      queryKey: queryKeys.artists.detail(id),
      queryFn: () =>
        import("@/features/artists/services/artistService").then((module) =>
          module.artistService.getArtist(id),
        ),
    }),
  ...
  songDetail: (id) =>
    queryClient.prefetchQuery({
      queryKey: queryKeys.songs.detail(id),
      queryFn: () =>
        import("@/features/music/services/songService").then((module) =>
          module.songService.getSong(id),
        ),
    }),
  ...
  playlistDetail: (id) =>
    queryClient.prefetchQuery({
      queryKey: queryKeys.playlists.detail(id),
      queryFn: () =>
        import("@/features/playlists/services/playlistService").then((module) =>
          module.playlistService.getPlaylist(id),
        ),
    }),
};
...
export const optimisticUpdates = {
  ...
  updateArtist: (id, updater) => {
    ...
    queryClient.setQueriesData({ queryKey: queryKeys.artists.lists() }, (oldData) => {
  ...
  updateSong: (id, updater) => {
    ...
    // Also update in lists
    queryClient.setQueriesData({ queryKey: queryKeys.songs.lists() }, (oldData) => {
      if (!oldData?.data) return oldData;
      return {
        ...oldData,
        data: oldData.data.map((song) => (song.id === id ? { ...song, ...updater(song) } : song)),
      };
    });
  },
  ...
  updatePlaylist: (id, updater) => {
    ...
    queryClient.setQueriesData({ queryKey: queryKeys.playlists.lists() }, (oldData) => {
      if (!oldData?.data) return oldData;
      return {
        ...oldData,
