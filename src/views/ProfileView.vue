<template>
  <WorkspacePage
    ...
    eyebrow="Account"
    title="Profile"
    subtitle="Manage identity, links, and personal workspace settings from one account surface."
  >
    <template #actions>
      <button class="workspace-header-primary-btn" @click="editMode = !editMode">
              ...
              <div class="preference-item">
                <div class="preference-info">
                  ...
                  <p class="preference-desc">
                    Receive updates about your projects and collaborations
                  </p>
                </div>
                <label class="toggle-switch">
                  <input
                    ...
                    type="checkbox"
                    @change="
                      updatePreference('email_notifications', preferences.email_notifications)
                    "
                  />
...
const getSocialIcon = (platform) => {
  const icons = {
    ...
    soundcloud:
      "M3 11v2c0 .55.45 1 1 1s1-.45 1-1v-2c0-.55-.45-1-1-1s-1 .45-1 1zm3-3v5c0 .55.45 1 1 1s1-.45 1-1V8c0-.55-.45-1-1-1s-1 .45-1 1zm3-3v8c0 .55.45 1 1 1s1-.45 1-1V5c0-.55-.45-1-1-1s-1 .45-1 1zm3-2v10c0 .55.45 1 1 1s1-.45 1-1V3c0-.55-.45-1-1-1s-1 .45-1 1zm3 2v8c0 .55.45 1 1 1s1-.45 1-1V5c0-.55-.45-1-1-1s-1 .45-1 1z",
  };
  return (
    icons[platform] ||
...
const saveSocial = async () => {
  try {
    ...
    const result = await apiService.update("user_profiles", profile.id, {
...
const updatePreference = async (key, value) => {
  try {
    await apiService.update("user_preferences", profile.id, { [key]: value });
...
input:checked + .toggle-slider {
  background: rgba(232, 90, 25, 0.24);
...
.header-background {
  background:
    radial-gradient(circle at top left, rgba(200, 75, 17, 0.18), transparent 36%),
    radial-gradient(circle at top right, rgba(19, 18, 17, 0.08), transparent 32%);
}
...
.avatar-placeholder {
  background: linear-gradient(135deg, rgba(19, 18, 17, 0.96), rgba(200, 75, 17, 0.92));
}
...
.role-badge.editor {
  ...
  border-color: rgba(26, 122, 74, 0.16);
}
...
.section-card:hover {
  ...
  box-shadow: 0 18px 40px rgba(19, 18, 17, 0.08);
}
...
.toggle-slider:before {
  background: #fff;
  box-shadow: 0 2px 6px rgba(19, 18, 17, 0.16);
}

input:checked + .toggle-slider {
  background: rgba(26, 122, 74, 0.18);
  border-color: rgba(26, 122, 74, 0.32);
}
...
.profile-view .profile-body {
  padding: 0;
  display: grid;
  gap: var(--section-gap);
}

.profile-view .profile-summary-card,
.profile-view .section-card {
  background:
...
.profile-view .avatar-placeholder {
  background: linear-gradient(135deg, rgba(200, 75, 17, 0.88), rgba(255, 255, 255, 0.92));
  color: var(--color-text-inverse);
}

.profile-view .change-avatar-btn {
  background: rgba(255, 255, 255, 0.9);
  border: 1px solid var(--color-border);
  color: var(--color-text);
}

.profile-view .change-avatar-btn:hover {
...
.profile-view .preference-label,
.profile-view .social-platform,
.profile-view .social-url {
  color: var(--color-text);
}
...
.profile-view .form-label,
.profile-view .preference-desc,
.profile-view .setting-help,
.profile-view .empty-social span {
  color: var(--color-text-secondary);
}
...
.profile-view .edit-section-btn,
.profile-view .cancel-btn {
  border: 1px solid var(--color-border);
  background: rgba(255, 255, 255, 0.82);
  color: var(--color-text);
}

.profile-view .edit-section-btn:hover,
.profile-view .cancel-btn:hover {
  border-color: var(--color-border-strong);
  background: rgba(255, 255, 255, 0.96);
}

.profile-view .form-input,
.profile-view .form-textarea {
  background: rgba(255, 255, 255, 0.82);
  border: 1px solid var(--color-border);
  color: var(--color-text);
}

.profile-view .save-btn {
  background: var(--color-accent);
  border-color: rgba(200, 75, 17, 0.16);
  color: var(--color-text-inverse);
}

.profile-view .save-btn:hover {
