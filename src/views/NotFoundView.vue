<template>
  <div class="min-h-screen flex items-center justify-center bg-dark-950 relative overflow-hidden">
    ...
    <div class="absolute inset-0">
      <div
        class="absolute inset-0 bg-gradient-to-br from-primary-900/10 via-dark-950 to-accent-900/10"
      ></div>
      <div
    ...
    <div class="relative z-10 text-center max-w-md mx-auto p-6">
      <!-- 404 Icon -->
      <div
        class="w-24 h-24 bg-gradient-to-br from-primary-500 to-accent-500 rounded-3xl mx-auto mb-8 flex items-center justify-center"
      >
        <svg
      ...
      <div class="space-y-4 mb-8">
        ...
        <p class="text-dark-400">The page you're looking for doesn't exist or has been moved.</p>
      </div>
      ...
      <div class="space-y-4">
        ...
        <div class="flex space-x-4">
          <router-link
            to="/artists"
            class="flex-1 py-2 text-primary-400 hover:text-primary-300 transition-colors text-center"
          >
            Browse Artists
          </router-link>
          ...
          <button
            @click="goBack"
            class="flex-1 py-2 text-dark-400 hover:text-white transition-colors"
          >
            Go Back
          </button>
        </div>
      ...
      <!-- Help Text -->
      <div class="mt-8 text-sm text-dark-500">
