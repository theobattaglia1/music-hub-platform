...
const ArtistProjectDetailView = () => import("@/views/ArtistProjectDetailView.vue");
...
const MoodboardDetailView = () => import("@/views/MoodboardDetailView.vue");
...
const routes = [
  ...
  {
    path: "/artists/:slug/projects/:projectId",
    name: "ArtistProjectDetail",
    component: ArtistProjectDetailView,
    meta: { requiresAuth: true },
    props: true,
  },
  {
  ...
  // One-sheet / EPK pages (standalone, no app chrome, no auth)
  {
    path: "/silas-carpenter-amf",
    name: "OneSheet_SilasCarpenter",
    component: () => import("@/views/onesheet/OnesheetView.vue"),
...
router.beforeEach(async (to, from, next) => {
  // Standalone pages skip auth entirely
